...
const BusinessSection = () => {
  return (
    <section className="bg-[#EFEFFF] flex flex-col items-center h-full md:h-auto">
      <h1 className="text-3xl font-bold mt-12 mb-3 text-center ">
      Explore the businesses
      </h1>
      <h3 className="my-5 text-center">We make it easy to work with professional, creative experts from around the world</h3>
